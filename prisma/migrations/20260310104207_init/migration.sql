...
-- CreateEnum
CREATE TYPE "ComplaintCategory" AS ENUM ('NOISE', 'CLEANLINESS', 'COMMON_AREA', 'OTHER');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ANNOUNCEMENT', 'PAYMENT_DUE', 'COMPLAINT', 'WARNING', 'EVENT', 'MESSAGE');
...
-- CreateIndex
CREATE UNIQUE INDEX "RoommatePost_userId_key" ON "RoommatePost"("userId");
...
-- AddForeignKey
ALTER TABLE "Complaint" ADD CONSTRAINT "Complaint_fromId_fkey" FOREIGN KEY ("fromId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Complaint" ADD CONSTRAINT "Complaint_aboutId_fkey" FOREIGN KEY ("aboutId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RoommatePost" ADD CONSTRAINT "RoommatePost_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
